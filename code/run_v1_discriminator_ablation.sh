...
for seed in 2718 451 9201; do
  run_one "${seed}" D1_target --discriminator-condition target
done

for seed in 2718 451 9201; do
  run_one "${seed}" D2_target_wrong_az --discriminator-condition target \
    --wrong-azimuth-discriminator-weight .25
done
